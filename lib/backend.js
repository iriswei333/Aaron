...
export function defaultStore() {
  return { users: {}, posts: [], playDates: [], familyEventCache: {}, playgroundCache: {}, parentingResourceCache: {}, familyEvents: [], familyRecurringItems: [], chatMessages: [] };
}
...
function normalizeStore(store) {
  return {
    ...
    parentingResourceCache: store?.parentingResourceCache && typeof store.parentingResourceCache === 'object'
      ...
      : {},
    familyEvents: Array.isArray(store?.familyEvents) ? store.familyEvents : [],
    familyRecurringItems: Array.isArray(store?.familyRecurringItems) ? store.familyRecurringItems : [],
